...
WDPA_path_poly_0= iface.addVectorLayer (WDPA_path_poly_0, "WDPA_poly_0", "org")
WDPA_path_poly_1= iface.addVectorLayer (WDPA_path_poly_1, "WDPA_poly_1", "org")
WDPA_path_poly_2= iface.addVectorLayer (WDPA_path_poly_2, "WDPA_poly_2", "org")
